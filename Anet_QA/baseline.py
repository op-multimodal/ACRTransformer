...
from rela_model import rela_embedding
import config
import numpy as np
from classifier import SimpleClassifier
from graph import Graph_Module
from gate import Gate_combine
import math
...
def build_baseline(dataset,opt):
    ...
    classifier=SimpleClassifier(opt.NUM_HIDDEN,opt.MID_DIM,opt.VOC_SIZE,opt.FC_DROPOUT)
