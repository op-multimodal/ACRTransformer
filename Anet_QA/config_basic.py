...
def parse_opt():
    ...
    '''path related'''
    parser.add_argument('--GLOVE_PATH',type=str,default='/home/caorui/video_feature/anet-qa/glove.6B.300d.txt')    
    '''tgif-qa related'''
    ...
    '''Anet-qa related'''
    parser.add_argument('--ANET_VIDEO_DIR',type=str,default='/mnt/data/caorui/ANET_BSN.h5df')
    parser.add_argument('--ANET_TEXT_DIR',type=str,default='/home/caorui/video_feature/anet-qa/activitynet-qa/dataset')
    ...
    parser.add_argument('--ANET_QA_DICT',type=str,default='/home/caorui/video_feature/anet-qa/activitynet-qa/dataset/qa_pairs.hdf5')
    #the path for qa pairs is not decided yet
    ...
    parser.add_argument('--C3D_SIZE',type=int,default=4096)    
    ...
    parser.add_argument('--ATT_V_DROPOUT',type=float,default=0.3)   
    parser.add_argument('--ATT_Q_DROPOUT',type=float,default=0.3)       
