...
def parse_opt():
	...
	parser.add_argument('--QUESTION_TYPE',type=str,default='Trans')
	...
	parser.add_argument('--NUM_HIDDEN',type=int,default=2036)
	parser.add_argument('--BIDIRECT',type=bool,default=False)
	parser.add_argument('--NUM_LAYER',type=int,default=1)
    
	parser.add_argument('--EMB_DROPOUT',type=float,default=0.282)
	parser.add_argument('--FC_DROPOUT',type=float,default=0.282)
	parser.add_argument('--L_RNN_DROPOUT',type=float,default=0.282)
